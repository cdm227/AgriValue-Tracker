...
function detectAdvisorLanguage(message) {
  ...
  const italianMarkers = [
    "ciao", "grazie", "per favore", "quanto", "come", "posso", "guadagnare",
    "olive", "olio", "uva", "vino", "raccolto", "contadino", "certificazione",
    "contratto", "migliore", "prezzo", "qualita", "qualità", "sicilia",
  ];
...
export function getAdvisorReply(message, context = {}) {
  ...
  if (lower.includes("matteo") || lower.includes("yield math") || lower.includes("processing cost") || lower.includes("costo") || lower.includes("conti") || lower.includes("resa")) {
  ...
  if (lower.includes("sofia") || lower.includes("golden seal") || lower.includes("certification seal") || lower.includes("sigillo") || lower.includes("certificazione") || lower.includes("qualita") || lower.includes("qualità")) {
    const opt = optimizeValueChain({ crop, qtyTons: context.qtyTons || 10, isOrganic: true });
  ...
  if (lower.includes("trade history") || lower.includes("memory") || lower.includes("storico") || lower.includes("memoria") || lower.includes("past trade") || lower.includes("ultimi trade") || lower.includes("ricord")) {
    return formatTradeMemoryReply(context.recentTrades || [], lang);
  }

  if (lower.includes("vision") || lower.includes("quality scan") || lower.includes("neural") || lower.includes("foto") || lower.includes("photo") || lower.includes("scan")) {
  ...
  if (lower.includes("fabric") || lower.includes("price") || lower.includes("market") || lower.includes("prezzo") || lower.includes("mercato") || lower.includes("guadagnare") || lower.includes("migliore")) {
    return advisorReply(
      lang,
  ...
  if (lower.includes("foundry") || lower.includes("compliance") || lower.includes("organic") || lower.includes("conformita") || lower.includes("conformità") || lower.includes("organico")) {
    return advisorReply(
      lang,
  ...
  if (lower.includes("work") || lower.includes("teams") || lower.includes("notify") || lower.includes("notifica") || lower.includes("avvisa")) {
    return advisorReply(
      lang,
  ...
  if (lower.includes("path b") || lower.includes("process") || lower.includes("trasforma") || lower.includes("trasformazione")) {
    return advisorReply(
      lang,
